...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      href="/cyworld_oracle/resources/css/guestbook_insert.css"
    />
    <link
  ...
  <body>
                  ...
                  <tr>
                    <td class="lastTd" colspan="2">
                      ...
                      <input
                        ...
                        type="button"
                        value="취소"
                        onclick="location.href='guestbook.do?idx=${param.idx}'"
                      />
                      <!-- 비밀글 설정 여부 -->
                      <select
                        class="textChoice"
    ...
    <!-- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -->
    <script src="/cyworld_oracle/src/main/webapp/resources/js/guestbook/guestbook_insert_form.js"></script>
  </body>
</html>
